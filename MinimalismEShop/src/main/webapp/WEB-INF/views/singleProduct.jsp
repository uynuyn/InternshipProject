                ...
                <div class="col-md-12">
                    <div class="product-bit-title">
                        <div class="product-breadcroumb">
                            <a href="">Home</a>
                            <spring:url value="/products/list/${p.category.department.code }" var="departmentUrl" />
							<a href="${departmentUrl }">${p.category.department.name }</a>
							<spring:url value="/products/list/${p.category.department.code }/${p.category.code }" var="productUrl" />
                            <a href="${productUrl }">${p.category.name }</a>
                            <a href="">${p.name }</a>
                        </div>
                            ...
                            <div class="col-sm-6">
                                <div class="product-inner">
                                    ...
                                    <div class="product-inner-category">
                                        <p>Category: <a href="">Ba lô</a>. Tags: <a href="">awesome</a>, <a href="">best</a>, <a href="">sale</a>, <a href="">shoes</a>. </p>
                                    </div> 
