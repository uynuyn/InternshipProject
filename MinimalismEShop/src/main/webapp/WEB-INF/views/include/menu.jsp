			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li class="dropdown"><a href="" class="dropdown-toggle"
						data-toggle="dropdown" id="departments">Departments<b
							class="caret"></b></a>
									...
									<c:forEach items="${sessionScope.listDepartment }" var="d">
										<div class="col-sm-3">
											<ul class="multi-column-dropdown">
												<spring:url value="/products/list/${d.code }"
													var="departmentUrl" />
												<li><h3>
														<a href="${departmentUrl }">${d.name }</a>
													</h3></li>
												<c:forEach items="${d.categories }" var="c">
													<spring:url value="/products/list/${d.code }/${c.code }"
														var="productUrl" />
