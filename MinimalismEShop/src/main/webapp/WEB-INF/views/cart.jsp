									...
									<table class="shop_table cart">
										...
										<tbody>
											<c:forEach items="${cart }" var="c" varStatus="i">
												<tr class="cart_item">
													<td class="product-remove"><spring:url
															value="/cart/remove/${c.value.id }" var="remove"></spring:url>
														<a title="Remove this item" class="remove"
														href="${remove }"><i class="fa fa-times"
													...
													<td class="product-price"><input hidden=""
														...
														value="${c.value.price }" id="b${i.index }" /> <span
														class="amount"> <fmt:formatNumber
																value="${c.value.price }" type="number" />
													</span></td>

													<td class="product-quantity">
														<div class="quantity buttons_added">
															<input hidden="" type="number" size="4"
																class="input-text qty text" title="Qty" value="1"
																min="0" step="1" id="${i.index }"> <span
																class="amount">${c.value.quantity }</span> <input
																hidden="" value="${c.value.id }" id="a${i.index }">
														</div>
													</td>

													<td class="product-subtotal"><span class="amount"
														id="d${c.value.id }"><fmt:formatNumber
																value="${c.value.total }" type="currency"
											...
											<tbody>
												<tr class="cart-subtotal">
													...
													<td><span class="amount"> <fmt:formatNumber
																value="${sessionScope.viewCart.amount }" type="currency"></fmt:formatNumber>
													</span></td>
												</tr>
												...
												<tr class="order-total">
													...
													<td><strong><span class="amount"> <fmt:formatNumber
																	value="${sessionScope.viewCart.amount }"
																	type="currency" />
														</span></strong></td>
												</tr>
											</tbody>
											...
											$
													.ajax({
														...
														success : function(
															...
															if (response == 0) {
																document
																		.getElementById("mycheckout").style.display = "none";
																document
																		.getElementById("cart_totalsid").style.display = "none";
																document
																		.getElementById("totalCartID").innerHTML = '0.0';
															}
														}
													});
