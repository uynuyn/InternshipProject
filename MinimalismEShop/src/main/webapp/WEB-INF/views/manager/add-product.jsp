...
<div id="page-wrapper">
	<div class="container-fluid">
		...
		<form:form action="${add }" class="checkout" method="POST"
			name="checkout" modelAttribute="addproductForm">
						...
						<spring:bind path="size">
							<p id="billing_size_field"
								...
								<form:select path="size">
									<form:option value="">No thing</form:option>
					...
					<div class="woocommerce-billing-fields">
						<spring:bind path="price">
							<p id="billing_price_field"
								...
								<form:input path="price" type="number" value="" placeholder=""
						...
						<spring:bind path="qty">
							<p id="billing_qty_field"
								...
								<form:input path="qty" type="number" value="1" placeholder=""
									id="billing_qty" name="billing_qty" class="input-text " min="1" />
					...
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-row" style="text-align: right;">
								...
								<input type="submit" data-value="SAVE"
									value="SAVE" id="place_order"
